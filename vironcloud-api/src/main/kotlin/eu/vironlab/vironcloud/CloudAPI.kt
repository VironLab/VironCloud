...
import eu.vironlab.vironcloud.common.service.DefaultServiceRepository
import eu.vironlab.vironcloud.common.service.ServiceRepository
...
abstract class  CloudAPI {
    ...
    val serviceRepository: ServiceRepository = DefaultServiceRepository()
